...
import { initialUserVerificationRoute } from "./user-verification/initial-route";
         ...
         children: [
            {
               ...
               pathname: initialUserVerificationRoute,
            },
            {
               icon: null,
      ...
      <div className="bg-sidebar p-0 h-full flex flex-col justify-between w-full md:px-4 md:py-6">
         ...
         <div className="flex justify-between w-full">
            <div className="flex items-center gap-2">
               <Image src="/images/avatar.png" className="rounded-full" alt="avatar" width={32} height={32} />
